...
class Drawing {
    ...
    static func draw(_ rect: Rectangle) {
    ...
    static func draw(_ square: Square) {
    ...
    static func draw(_ ellipse: Ellipse) {
    ...
    static func draw(_ circle: Circle) {
